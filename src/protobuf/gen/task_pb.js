...
proto.task.CreateTaskParams.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    executionmode: jspb.Message.getFieldWithDefault(msg, 5, 0)
  };
...
/**
 * optional ExecutionMode executionMode = 5;
 * @return {!proto.task.ExecutionMode}
 */
proto.task.CreateTaskParams.prototype.getExecutionmode = function() {
  return /** @type {!proto.task.ExecutionMode} */ (jspb.Message.getFieldWithDefault(this, 5, 0));
};
